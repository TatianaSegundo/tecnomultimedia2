...
boolean eliminarNota=false;
  ...
  eliminarNota=false;}
   ...
   //Barra sin pintar
    if(entroFragmento[0]==false){image(barra[0],600,50);}
    if(entroFragmento[0]==false){image(barra[1],660,50);}
    if(entroFragmento[1]==false){image(barra[2],695,50);}
    if(entroFragmento[1]==false){image(barra[3],710,50);}
    if(entroFragmento[2]==false){image(barra[4],760,50);}
    if(entroFragmento[2]==false){image(barra[5],815,50);}
    if(entroFragmento[3]==false){image(barra[6],870,50);}
    if(entroFragmento[3]==false){image(barra[7],920,50);}
    if(entroFragmento[4]==false){image(barra[8],980,50);}
    if(entroFragmento[5]==false){image(barra[9],1000,50);}
   
//Barra pintada, cambia segun el fragmento que entre
    if(entroFragmento[0]==true){image(barraColor[0],600,50);}
    if(entroFragmento[0]==true){image(barraColor[1],660,50);}
    if(entroFragmento[1]==true){image(barraColor[2],695,50);}
    if(entroFragmento[1]==true){image(barraColor[3],710,50);}
    if(entroFragmento[2]==true){image(barraColor[4],760,50);}
    if(entroFragmento[2]==true){image(barraColor[5],815,50);}
    if(entroFragmento[3]==true){image(barraColor[6],870,50);}
    if(entroFragmento[3]==true){image(barraColor[7],920,50);}
    if(entroFragmento[4]==true){image(barraColor[8],980,50);}
    if(entroFragmento[5]==true){image(barraColor[9],1000,50);}
    //mapeo la marca de tiempo 
float mover= map(marcaDeTiempo3,0,tiempo2,600,900);
